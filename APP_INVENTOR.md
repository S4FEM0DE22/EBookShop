...
เว็บ Production พร้อมใช้งานที่ `https://safemode-shop.vercel.app/` ซึ่งใช้แทน `localhost` บนมือถือ
...
3. ลาก `WebViewer` หนึ่งตัวชื่อ `WebViewer1` วางบน `Screen1`; ตั้ง `Width = Fill parent`, `Height = Fill parent`, `HomeUrl = https://safemode-shop.vercel.app/`, `FollowLinks = true`, `IgnoreSslErrors = false`, `UsesLocation = false`
