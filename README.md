...
หน้าติดตามแสดงคำสั่งซื้อที่สร้างหรือค้นพบใน session นี้ตามภาพต้นแบบ พร้อมสถานะ ปุ่ม Mock Payment และปุ่มยกเลิกสำหรับรายการที่ยัง `PENDING` หากต้องการดูคำสั่งซื้อที่ไม่ได้อยู่ใน session ให้กรอกเลขคำสั่งซื้อกับอีเมลในช่องค้นหาด้านล่าง หน้าประวัติแสดงทั้งรายการที่ชำระแล้วและรายการที่ยกเลิก
