...
| ทดสอบอีเมล | โหมดในเครื่องแสดงผล `DEMO`; การทดสอบผ่าน Supabase แสดง `NOT_CONFIGURED` และมีลิงก์ดาวน์โหลดบนหน้าเว็บ ทดสอบกรณี Resend ติดต่อไม่ได้แล้ว: ระบบคืน `FAILED` พร้อมลิงก์ดาวน์โหลด และส่งซ้ำด้วยคำขอเดิมได้ ยังไม่ได้ส่งอีเมลจริง |
