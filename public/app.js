...
function statusInfo(order) {
  if (order.status === 'PAID') return { className: 'paid', label: 'E-Book พร้อมใช้งาน', short: 'PAID' };
